...
export function toString2(num) { return num.toString(2); }
export function toString8(num) { return num.toString(8); }
export function toString16(num) { return num.toString(16); }
export function toString32(num) { return num.toString(32); }
export function toString36(num) { return num.toString(36); }
...
export function toString62(num) { return numsys_2_62(num); }
const numsys_2_64 = numsys2n(64);
export function toString64(num) { return numsys_2_64(num); }
const numsys_2_128 = numsys2n(128);
export function toString128(num) { return numsys_2_128(num); }
const numsys_2_256 = numsys2n(256);
export function toString256(num) { return numsys_2_256(num); }
const numsys_2_512 = numsys2n(512);
export function toString512(num) { return numsys_2_512(num); }
export function toStringN(num, radix) {
    if (radix == '正') {
